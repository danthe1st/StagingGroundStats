...
I took the last 100 pages of Staging Ground approvals (state: 27.9.2024) from the review history, grouped these by user, filtered out inactive users and created bar charts out of it.
